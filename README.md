# Keycloak Web Guard for Laravel (Filament edition)

> Forked from [mariovalney/laravel-keycloak-web-guard](https://github.com/mariovalney/laravel-keycloak-web-guard). This variant adapts the guard for Filament panels and renames the namespace to `Ebrook\KeycloakWebGuard` while keeping the original MIT license and attribution.
...
```
composer require ebrook/filament-keycloak-web-guard
```
...
### Filament setup (example)

To use this package as the Filament auth/login/logout flow:
...
In this same configuration you setted the model. So you can register your own model extending `Ebrook\KeycloakWebGuard\Models\KeycloakUser` class and changing this configuration.
...
* Maintained in this fork by Ebrook (antony@ebrook.com.tw)
